...
xilinx.com:hls:myproject_auto_accel:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: myproject_auto_accel_0, and set properties
  set myproject_auto_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:myproject_auto_accel:1.0 myproject_auto_accel_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins myproject_auto_accel_0/s_axis_in]
  ...
  connect_bd_intf_net -intf_net myproject_auto_accel_0_s_axis_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins myproject_auto_accel_0/s_axis_out]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins myproject_auto_accel_0/s_axi_CTRL] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs myproject_auto_accel_0/s_axi_CTRL/Reg] -force
